...
// class LibarianSignupPage extends StatelessWidget {
//   LibarianSignupPage({ Key? key }) : super(key: key);
...
//                         userController.userSignupController(nameText, lastNameText, rollNumberText, courseText, degree, emailText, phoneNumberText, passwordText, roleText);
//                         Get.snackbar("Sucess", "Register Sucefully, Login",snackPosition: SnackPosition.TOP);
//                         // Get.to(() => LoginPage());
//                         // Get.toNamed("/loans");
//                       }else{
