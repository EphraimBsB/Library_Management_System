...
import 'package:library_magement_sys/views/pages/book.pages/single.book.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/books/single_book/:id', page: () => SingleBook()),
        GetPage(name: '/login', page: () => LoginPage()),
        GetPage(name: '/admin', page: () => LibrarianLoginPage()),
        GetPage(name: '/register', page: () => SignupPage()),
        GetPage(name: '/signin', page: () => AccountLogin()),
